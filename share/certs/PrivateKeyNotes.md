...
unlocked to sign the YorkCoin-QT.app bundle.
...
allowing somebody to distribute a YorkCoin-QT.app or YorkCoin-qt-setup.exe with a valid
...
that the YorkCoin-qt.exe file inside the installer had not been tampered with.
